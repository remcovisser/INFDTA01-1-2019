...
namespace DataScience
{
    class MainClass
    {
        public static void Main(string[] args)
        {
           ...
           // Average
            Console.WriteLine("User 1 average = " +  itemItem.UserAverage(1));
            Console.WriteLine("User 2 average = " +  itemItem.UserAverage(2));
            Console.WriteLine("User 3 average = " +  itemItem.UserAverage(3));
            Console.WriteLine("User 4 average = " +  itemItem.UserAverage(4));
            Console.WriteLine("User 5 average = " +  itemItem.UserAverage(5));
