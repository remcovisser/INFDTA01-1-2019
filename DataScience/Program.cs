...
namespace DataScience
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            Dictionary<int, Dictionary<int, double>> dataMovieLensSmall = importer.GetMovielensData(dataPath, movieLensData);
            new PredictingRatings(pearson, dataMovieLensSmall, 5).DoCalculation(PRINT);
            ...
            new NearestNeighbours(pearson, dataMovieLensSmall, 20, 50, 0.35).DoCalculation(PRINT);
...
//            PrintResults.PrintAverages(averages);
            ...
            itemItem = new ItemItem(dataMovieLensSmall);
